...
3. **声音来源**：自己录 / 付费录制并拿授权 / 公开授权数据集。定了才谈得上炼丹，见 M5。
4. 三个技术选型待定项（语音链路、记忆抽取用哪个模型、桌宠窗口形态）。
...
- **「她会问的问题」**：2026-09-03 提出但没说清指哪一块，明天确认。可能是反模板句规则
  没压住她的提问频率、右侧「快速开始」那三条预设、或者主动消息里该不该带问题。
