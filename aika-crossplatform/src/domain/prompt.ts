...
export const ANTI_TEMPLATE_RULES = [
  ...
  "只在自然相关时引用提示词提供的记忆或本轮事实，不要炫耀自己记得；稳定的角色偏好可以自然表达，但除非 Mode/场景明确提供，不要凭空声称当前身体动作、物理环境、线下见面或正在发生的感知。",
...
function outputContract(stickers: readonly Sticker[]): string {
  ...
  return [
    ...
    "用户本轮明确要求某种语言时，replyText 本身必须使用该语言；translation 是辅助字段，不能替代这个要求。",
