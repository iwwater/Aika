...
await build({ entryPoints: [root + 'main.mjs'], bundle: true, format: 'esm', platform: 'browser', target: ['safari17', 'chrome130'], outfile: root + 'build/renderer.js', sourcemap: true, legalComments: 'eof', plugins: modelPlugins });
