...
| **Ikaros-521 / AI-Vtuber 及贡献者** | AI 虚拟主播项目：可参考模型、语音与虚拟形象的互动设计。 | [AI-Vtuber 原始仓库](https://github.com/Ikaros-521/AI-Vtuber) |
| **Hume** | 语音提示词指南：面向说话而非文章组织回复，并结合实际提供的情绪线索回应。 | [Prompt Engineering for EVI](https://dev.hume.ai/docs/speech-to-speech-evi/guides/prompting) |
...
The table lists what to explore and links to the original sources.
...
| **Ikaros-521 / AI-Vtuber and contributors** | A virtual streamer project combining models, speech and avatar interaction. | [AI-Vtuber repository](https://github.com/Ikaros-521/AI-Vtuber) |
| **Hume** | Spoken-response prompting and responding to available emotional cues. | [Prompt Engineering for EVI](https://dev.hume.ai/docs/speech-to-speech-evi/guides/prompting) |
...
Thank you to these authors and communities for sharing their work.
